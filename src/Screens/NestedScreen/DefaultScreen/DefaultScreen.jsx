...
const DefaultScreen = ({ navigation }) => {
  ...
  return (
    <View style={postScreenStyle.container}>
      <ProfileAvatar
        name={userData.auth.login}
        mail={userData.auth.userEail}
        title={!userAvator ? avaFunc(userData.auth.login) : null}
        photo={userAvator}
      />
      {posts && (
        <View>
                    ...
                    <View style={postScreenStyle.posInfoBox}>
                      ...
                      >
                        ...
                        >
                          <Feather
                            style={{
                              ...postScreenStyle.iconMessage,
                              color: !item.counts ? "#BDBDBD" : "#FF6C00",
                            }}
                            name="message-circle"
                            size={24}
                          />
                          {
                            <Text
                              style={{
                                color: !item.counts ? "#BDBDBD" : "#212121",
                                fontSize: 16,
                              }}
                            >
                              {!item.counts ? "0" : item.counts}
                            </Text>
                          }
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                          <AntDesign
                            ...
                            style={{
                              marginRight: 5,
                              marginBottom: 2,
                              color: !item.likes ? "#BDBDBD" : "#FF6C00",
                            }}
                          />
                          <Text
                            style={{
                              color: !item.likes ? "#BDBDBD" : "#212121",
                              fontSize: 16,
                            }}
                          >
                            {item.likes}
